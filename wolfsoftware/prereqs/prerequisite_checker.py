...
are installed on the system. It defines a function to verify the presence of specified
commands and raises a custom exception if any commands are not found.
